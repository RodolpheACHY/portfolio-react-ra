...
// Racines primitives Radix (inchangées)
const Sheet = SheetPrimitive.Root
const SheetTrigger = SheetPrimitive.Trigger
const SheetClose = SheetPrimitive.Close
const SheetPortal = SheetPrimitive.Portal

// Overlay avec forwardRef (bonne pratique React + Radix)
...
// ✅ Gestion centralisée des variantes via cva()
...
// Contenu du Sheet avec close button intégré
...
// Sous-composants (header, footer, title, description)
